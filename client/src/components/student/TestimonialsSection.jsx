...
const TestimonialsSection = () => {
  return (
    <div className='pb-14 px-8 md:px-8'>
      ...
      <p className='md:text-base text-gray-500 mt-3'>Hear from our learners as they share their journeys of transformation, sucess, and how our <br/> platfrom has made a difference in their lives.</p>
